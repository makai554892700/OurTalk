...
import www.mys.com.ourtalk.utils.RegularUtils;
import www.mys.com.ourtalk.utils.file.CMDUtils;
import www.mys.com.ourtalk.utils.file.CloseUtils;
...
public class HttpUtils {
    ...
    public byte[] getURLResponse(String urlString, HashMap<String, String> heads, int timeOut) {
        ...
        if (urlString != null) {
            ...
            try {
                java.net.URL url = new URL(urlString); //URL对象
    ...
    public void getURLResponse(String urlString, HashMap<String, String> heads, Proxy proxy, IWebCallback iWebCallback, int timeOut) {
        if (urlString != null) {
            HttpURLConnection conn = null; //连接对象
            java.io.InputStream is = null;
            ByteArrayOutputStream baos = null;
